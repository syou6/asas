/* eslint-env browser */
import { encodeAudioToPCM16, decodePCM16ToFloat32, resampleAudioSync, } from "./audioCodec";
/**
...
export class AudioStreamManager {
    constructor() {
        ...
        Object.defineProperty(this, "processorNode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "playbackQueue", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "isPlayingAudio", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "playbackSourceNode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "nextPlaybackTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "playbackGainNode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "scheduledBuffersCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
     ...
     */
    startCapture(stream, onAudioChunk, targetSampleRate = 16000) {
    ...
    playNextChunk(sampleRate) {
        ...
        while (this.playbackQueue.length > 0 && this.scheduledBuffersCount < 3) {
            ...
            // Create audio buffer
            const audioBuffer = this.audioContext.createBuffer(1, // mono
            mergedChunk.length, sampleRate);
            // Copy data to buffer
