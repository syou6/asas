...
export class Converter {
    constructor(options = {}) {
        ...
        Object.defineProperty(this, "detailLevel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 32
        ...
        Object.defineProperty(this, "transformStack", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    applyCurrentTransform(object) {
        const transform = this.currentTransform();
        object.applyMatrix4(transform.matrix);
    }
    applyExplicitTransforms(object, properties) {
    ...
    evaluateVector3(value) {
        if (value === undefined)
            return [0, 0, 0];
        if (Array.isArray(value) && typeof value[0] === "number") {
            return value;
        }
        return this.evaluator.evaluateToVector3(value);
    }
    evaluateTranslateVector(value) {
    ...
    evaluateColor(value) {
        ...
        return this.evaluator.evaluateToColor(value);
    }
    evaluateVector3OrColor(value) {
...
export function astToThreeJS(nodes, options = {}) {
