...
(__VLS_ctx.result.jsonData?.query || __VLS_ctx.extractQueryFromMessage(__VLS_ctx.result.message));
// @ts-ignore
[result, result, extractQueryFromMessage,];
...
const __VLS_self = (await import('vue')).defineComponent({
    setup: () => ({
        extractQueryFromMessage: extractQueryFromMessage,
    }),
    __typeProps: {},
});
