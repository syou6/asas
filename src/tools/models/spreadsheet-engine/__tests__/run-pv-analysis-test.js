...
try {
    ...
    console.log("This test will timeout after 5 seconds if there's an infinite loop");
    ...
    console.log("\nFirst few months:");
    for (let i = 8; i <= 11; i++) {
        console.log(`Month ${result.data[i][0]}: Cash Flow ${result.data[i][1]}, PV ${result.data[i][2]}`);
    }
