...
export async function loadBlankImageBase64() {
            ...
            beats: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        imagePrompt: {
                            type: "string",
                            description: "The optional prompt to be used to generate an image. Typically 50 to 70 words.",
                        },
                    },
                    required: ["text"],
...
const mulmocast = async (context, args) => {
    ...
    const imageRefs = [blankImageBase64];
...
export const plugin = {
    ...
    waitingMessage: "Tell the user that the script was written and we are genenerating images and video with Mulmocast.",
    isEnabled: () => true,
