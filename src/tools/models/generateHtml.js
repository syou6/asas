...
const toolDefinition = {
    type: "function",
    name: toolName,
    description: "Generate a complete, standalone HTML page by sending a detailed prompt to another LLM (Claude). This tool uses AI to write HTML, CSS, and JavaScript based on your description. The generated HTML will be self-contained with all styles and scripts inline, requiring no external dependencies.",
    parameters: {
        type: "object",
        properties: {
            prompt: {
                type: "string",
                description: "Detailed description of the desired HTML page. Be specific about layout, styling, interactivity, colors, animations, and functionality. The more detailed your prompt, the better the generated HTML will match your requirements. This prompt will be sent to another AI model (Claude) that specializes in HTML generation.",
            },
        },
        required: ["prompt"],
    },
};
const generateHtml = async (context, args) => {
    ...
    try {
        ...
        if (data.success && data.html) {
            return {
                ...
                instructions: "Acknowledge that the HTML was generated and has been already presented to the user.",
            };
        }
        else {
            console.error("ERR:1\n no HTML data", data);
...
export const plugin = {
    ...
    isEnabled: (startResponse) => !!startResponse?.hasAnthropicApiKey || !!startResponse?.hasGeminiApiKey,
